...
,
    ...
    { id: 90, code: "090", name: "Buqué Sol Radiante — Girasol y Margaritas Amarillas", price: 34500, image: "../assets/foto90.webp", description: "Girasol central rodeado de margaritas amarillas y gypsophila, envuelto en papel blanco con filo dorado y moño amarillo. Un ramo que ilumina la casa apenas cruza la puerta.", categories: ["ramos", "girasoles", "precio-bajo"] },
    { id: 91, code: "091", name: "Centro de Mesa Girasol con Gerberas Amarillas", price: 30000, image: "../assets/foto91.webp", description: "Base de helechos frescos con gerberas amarillas y blancas, gypsophila y un girasol elevado en tubo de vidrio. Perfecto para el centro de la mesa en cumpleaños, oficinas y celebraciones familiares.", categories: ["especiales", "girasoles", "precio-bajo"] },
    { id: 92, code: "092", name: "Cúpula de Cristal con Girasol Preservado", price: 52500, image: "../assets/foto92.webp", description: "Girasol preservado bajo cúpula de vidrio, sobre base de madera y piedras blancas. Un detalle que no se marchita: queda de recuerdo en el escritorio o el velador.", categories: ["especiales", "girasoles", "precio-medio"] },
    { id: 93, code: "093", name: "Buqué Primavera Amarilla con Rosa y Mariposa Dorada", price: 45000, image: "../assets/foto93.webp", description: "Margaritas amarillas, crisantemos blancos y una rosa amarilla al centro, con mariposa dorada, papel blanco y moño amarillo. Fresco, luminoso y alegre para cumpleaños y buenas noticias.", categories: ["ramos", "precio-medio"] },
    { id: 94, code: "094", name: "Buqué Rústico Girasol y Crisantemos Blancos", price: 21000, image: "../assets/foto94.webp", description: "Girasol acompañado de crisantemos blancos, solidago y eucalipto, envuelto en arpillera natural con moño amarillo. Sencillo, campestre y con mucho encanto.", categories: ["ramos", "girasoles", "precio-bajo"] },
    { id: 95, code: "095", name: "Buqué Campestre Girasol, Rosa Amarilla y Astromelias", price: 31500, image: "../assets/foto95.webp", description: "Girasol, rosa amarilla y astromelias durazno con gypsophila y helecho cuero, sobre papel de arpillera con moño amarillo. Calidez de campo para regalar sin esperar una fecha especial.", categories: ["ramos", "girasoles", "precio-bajo"] },
    { id: 96, code: "096", name: "Buqué Lluvia de Sol — Margaritas Amarillas", price: 49500, image: "../assets/foto96.webp", description: "Ramo abundante de margaritas amarillas con gypsophila, envuelto en papel blanco con filo dorado y moño amarillo. Volumen y color puro: el favorito para alegrarle el día a alguien.", categories: ["ramos", "precio-medio"] },
    { id: 97, code: "097", name: "Caja Premium de Girasoles con Tapa Negra", price: 39000, image: "../assets/foto97.webp", description: "Girasoles, margaritas amarillas y gypsophila montados dentro de una caja transparente con tapa negra y asa. Llega listo para regalar, sin necesidad de florero.", categories: ["cajas", "girasoles", "precio-medio"] },
    { id: 98, code: "098", name: "Florero Minimalista con Girasol y Flores Silvestres", price: 33000, image: "../assets/foto98.webp", description: "Un girasol con solidago y flores silvestres blancas en florero de vidrio delgado. Detalle sobrio y luminoso para escritorios, recepciones y regalos discretos.", categories: ["especiales", "girasoles", "precio-bajo"] },
    { id: 99, code: "099", name: "Florero Alegría con Gerberas Amarillas", price: 36000, image: "../assets/foto99.webp", description: "Dos gerberas amarillas con solidago y follaje fresco en florero de vidrio texturizado con moño amarillo. Pequeño, alegre y directo al corazón.", categories: ["especiales", "precio-bajo"] },
    { id: 100, code: "100", name: "Buqué Dorado de Girasoles con Eucalipto", price: 67500, image: "../assets/foto100.webp", description: "Girasoles en cascada con eucalipto y gypsophila, envueltos en papel dorado con moño amarillo. Presentación alargada y señorial para una entrega que impresiona.", categories: ["ramos", "girasoles", "precio-medio"] },
    { id: 101, code: "101", name: "Buqué Kraft de Girasoles con Matricaria y Eucalipto", price: 43500, image: "../assets/foto101.webp", description: "Girasoles con matricaria blanca y eucalipto, envueltos en papel kraft con interior lila, cinta beige y tarjeta dedicada. Estilo natural y sofisticado, muy fotogénico.", categories: ["ramos", "girasoles", "precio-medio"] },
    { id: 102, code: "102", name: "Buqué Tres Girasoles en Papel Rosa", price: 31500, image: "../assets/foto102.webp", description: "Tres girasoles con gypsophila y follaje fino, envueltos en papel rosa y blanco con moño crema. La combinación dulce y luminosa que nunca falla.", categories: ["ramos", "girasoles", "precio-bajo"] },
    { id: 103, code: "103", name: "Buqué Sol de Otoño — Margaritas Amarillas y Solidago", price: 45000, image: "../assets/foto103.webp", description: "Margaritas amarillas con solidago y follaje verde, en papel naranja y blanco con cinta verde y tarjeta dedicada. Cálido, vibrante y perfecto para agradecer.", categories: ["ramos", "precio-medio"] },
    { id: 104, code: "104", name: "Mega Bouquet Girasoles con Mariposas Doradas", price: 82500, image: "../assets/foto104.webp", description: "Corona abundante de girasoles sobre papel negro, con mariposas doradas y moño dorado. Contraste dramático y de lujo: el ramo que se recuerda por años.", categories: ["ramos", "girasoles", "premium", "precio-medio"] },
    { id: 105, code: "105", name: "Buqué Girasoles con Claveles Fucsia y Chocolate", price: 70500, image: "../assets/foto105.webp", description: "Girasoles rodeados de mini claveles fucsia y rosados, con tarjeta dedicada y chocolate incluido, sobre papel rosa. Flores y dulce en un solo regalo.", categories: ["ramos", "girasoles", "especiales", "precio-medio"] },
    { id: 106, code: "106", name: "Caja Corazón de Girasoles", price: 67500, image: "../assets/foto106.webp", description: "Girasoles y gypsophila montados en caja corazón blanca con moño amarillo. Amor y alegría en la misma pieza, lista para entregar.", categories: ["cajas", "girasoles", "precio-medio"] },
    { id: 107, code: "107", name: "Sombrerera Premium de Girasoles", price: 135000, image: "../assets/foto107.webp", description: "Sombrerera blanca colmada de girasoles con eucalipto fresco. Nuestra pieza más generosa en amarillo: presencia total para aniversarios, oficinas y grandes celebraciones.", categories: ["cajas", "girasoles", "premium", "precio-alto"] },
